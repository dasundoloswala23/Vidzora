...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
  ...
  Future<void> _finish() async {
    // No explicit navigation: marking the flag fires the router's
    // refreshListenable, whose redirect maps /onboarding -> /home. Doing both
    // raced and produced a visible double transition.
  ...
  Widget build(BuildContext context) {
    ...
    // No AppBar here to carry the theme's systemOverlayStyle, so declare it
    // explicitly — otherwise the splash's light status bar persists onto
    // this light background and the clock becomes unreadable.
